...
class ProvincialReminderController extends Controller
{
    ...
    public function index(Request $request): View|RedirectResponse
    {
        ...
        $perPage  = max(5, min(50, (int) $request->query('per_page', 5)));
        $recentReminders = $this->provincialReminderService->recentRemindersForOfficePaginated($user->office, $perPage, $request);
