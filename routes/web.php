...
Route::controller(AdminDashboardController::class)->group(function () {
    Route::middleware('role.session:super_admin,hr-super-admin')->group(function () {
        ...
        // Dedicated poll endpoint for Super Admin — must be under super_admin middleware,
        // NOT the ph-admin poll endpoint, which would flush the super admin session.
        Route::get('/dashboard/super-admin/poll', 'reportsPoll')->name('super-admin.poll');
    ...
    Route::middleware('role.session:admin,ph-admin')->group(function () {
        ...
        Route::prefix('dashboard/admin')
            ...
            ->group(function () {
                ...
                Route::get('/poll', 'reportsPoll')->name('poll'); // lightweight polling
...
Route::middleware('staff.session')->group(function () {
    ...
    Route::controller(StaffNotificationController::class)->group(function () {
        ...
        Route::get('/staff/notifications/page', 'viewAll')->name('staff.notifications.page');
    });
...
Route::controller(ReportController::class)->prefix('staff/reports')->name('staff.reports.')->group(function () {
    ...
    Route::get('/poll', 'statusPoll')->name('poll');  // lightweight status polling
    ...
    Route::controller(StaffNotificationController::class)->group(function () {
        ...
        Route::get('/intern/notifications/page', 'viewAll')->name('intern.notifications.page');
    });
