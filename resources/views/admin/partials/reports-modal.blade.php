                ...
                <div class="sidebar-card">
                    ...
                    @if ($canManageReportRecords)
                        ...
                        <div class="action-stack" style="margin-top:16px;display:grid;gap:12px;">
                            ...
                            <button type="button" class="modal-secondary-button" style="margin-top: 10px" data-return-button hidden>Return For Revision</button>
                        </div>
                        <div class="review-feedback" data-review-feedback style="display:none;"></div>
                    @else
