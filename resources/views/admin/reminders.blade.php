                ...
                <section class="table-panel">
                    <div class="section-header">
                        ...
                        <form method="GET" action="{{ url()->current() }}" style="display:flex;align-items:center;gap:8px;">
                            <label for="reminders-per-page" style="font-size:13px;color:#6b7280;font-weight:500;white-space:nowrap;">Rows per page:</label>
                            <select id="reminders-per-page" name="per_page" onchange="this.form.submit()"
                                    style="border:1px solid #e5e7eb;border-radius:10px;padding:6px 12px;font-size:13px;font-weight:600;color:#374151;background:#fff;cursor:pointer;">
