                    ...
                    @else
                        <div class="notification-list">
                            @foreach ($superAdminNotifications as $notification)
                                <div class="notification-item {{ $notification->read_status ? 'notification-item--read' : 'notification-item--unread' }}">
                        ...
                        @foreach ($submissionNotifications as $notification)
                            ...
                            <a href="{{ $notification->route }}" class="notification-item notification-item--unread">
                                ...
                                <span class="notification-copy">
                                    ...
                                    <span class="notification-description">{{ $submissionLabel }}</span>
                                    <span class="notification-meta">
                                        <small>
